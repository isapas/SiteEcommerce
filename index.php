                      ...
                      <div class="card-body">
                        <form class="form" role="form" autocomplete="off">
                          <div class="form-group">
                            ...
                            <input type="text" pattern="{6,}" class="form-control" id="name" placeholder="Votre nom (3 caractères min.)">
                          </div>

                          <div class="form-group">
                            <label for="password">Mot de passe</label>
                            <input type="password" pattern="(?=.*\d)(?=.*[A-Z]).{6,}"  class="form-control" id="password" placeholder="Mot de passe 6 caractères min. un chiffre et une lettre en capitale" title="6 caracteres minimum avec un chiffre et une lettre en capitale" required="">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <button type="submit" name="subscribe" class="btn btn-success btn-lg float-right">S'enregistrer</button>
                          </div>
                        </form>
                    </div>
                  </div>
